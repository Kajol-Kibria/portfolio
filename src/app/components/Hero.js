...
export default function Hero() {
  ...
  return (
    <div className='h-[calc(100vh-6rem)] flex justify-center items-center p-10 sm:p-0'>
       <div>
        <Image className='sm:block hidden' src="/images/hero.webp" width={688} height={300} quality={100}></Image>
       </div>
       <div>
        <h1 className='text-2xl'><span className='text-6xl font-bold py-10'>Hello there, I'm <span className='text-rose-600'>Kibria</span></span></h1>
